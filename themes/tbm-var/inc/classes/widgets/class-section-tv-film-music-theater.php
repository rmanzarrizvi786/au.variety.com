...
/**
 * Homepage section widget (TV, Film, Music, Theater)
 *
 * @package pmc-variety
 */
...
/**
 * Class Section_TV_Film_Music_Theater
 */
class Section_TV_Film_Music_Theater extends Variety_Base_Widget
{

	const ID = 'section-tv-film-music-theater';
	...
	public function __construct()
	{
		parent::__construct(
			static::ID,
			__('Variety Section - TV, Film, Music, Theater', 'pmc-variety'),
			[
				'description' => __('Displays the TV, Film, Music, Theater section', 'pmc-variety'),
			]
		);
	}
