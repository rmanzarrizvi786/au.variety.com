...
$section = PMC\Core\Inc\Larva::get_instance()->get_json('modules/homepage-tv-film-music-radio.prototype');
...
\PMC::render_template(
	sprintf('%s/template-parts/patterns/modules/homepage-tv-film-music-radio.php', untrailingslashit(CHILD_THEME_PATH)),
	$section,
	true
);
