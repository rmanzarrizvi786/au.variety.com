	...
	<?php if (!empty($c_lazy_image)) { ?>	
		<div class="o-story__secondary lrv-a-glue-parent // <?php echo esc_attr($o_story_secondary_classes ?? ''); ?>">
			<?php if((int) $c_lazy_image['post_id'] == (int) 9536) { ?>
				...
				<?php } else { ?>
				<img class="c-lazy-image__img <?php echo esc_attr($c_lazy_image_img_classes ?? ''); ?>" src="https://images.thebrag.com/var/uploads/2023/07/gary-vee.jpg" alt="<?php echo esc_attr($c_lazy_image_alt_attr ?? ''); ?>" data-lazy-srcset="<?php echo esc_attr($c_lazy_image_srcset_attr ?? ''); ?>" data-lazy-sizes="<?php echo esc_attr($c_lazy_image_sizes_attr ?? ''); ?>" height="<?php echo esc_attr($c_lazy_image_height_attr ?? ''); ?>" width="<?php echo esc_attr($c_lazy_image_width_attr ?? ''); ?>">
				<?php } ?>
