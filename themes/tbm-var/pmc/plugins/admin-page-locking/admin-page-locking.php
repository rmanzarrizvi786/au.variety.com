...
define( 'PMC_CORE_ADMIN_PAGE_LOCKING_PATH', __DIR__ );
define( 'PMC_CORE_ADMIN_PAGE_LOCKING_URL', untrailingslashit( plugins_url( '', __FILE__ ) ) );
	...
	'after_setup_theme', function() {
		...
		if ( ! empty( $screens ) ) {
			foreach ( $screens as $screen ) {
				new \PMC\Core\Plugins\Admin_Page_Locking\Screen( $screen );
			}
		}
	}
);
