...
<div class="c-email-field <?php echo esc_attr($modifier_class ?? ''); ?> <?php echo esc_attr($c_email_field_classes ?? ''); ?>">
	...
	<input class="c-email-field__input <?php echo esc_attr($c_email_field_input_classes ?? ''); ?>" name="<?php echo esc_attr($c_email_field_input_name_attr ?? ''); ?>" id="<?php echo esc_attr($c_email_field_input_id_attr ?? ''); ?>" required type="email" placeholder="<?php echo esc_attr($c_email_field_input_placeholder_attr ?? ''); ?>" />
</div>