...
c_button_struct.c_button_classes += ' lrv-u-color-white:hover lrv-u-border-radius-5 lrv-u-text-align-center lrv-u-font-size-28 u-box-shadow-dark u-background-color-brand-primary-dark:hover';
...
c_button_prev.c_button_classes += ' lrv-a-icon-arrow-left lrv-a-icon-invert lrv-a-icon-before lrv-u-width-300 u-width-150@mobile-max lrv-u-font-size-18@mobile-max lrv-u-justify-content-center';
c_button_prev.c_button_text = 'Previous';
c_button_prev.c_button_url = '#';

c_button_next.c_button_classes += ' lrv-a-icon-arrow-right lrv-a-icon-invert lrv-a-icon-after lrv-u-width-300 u-width-150@mobile-max lrv-u-font-size-18@mobile-max lrv-u-justify-content-center lrv-u-margin-l-auto';
