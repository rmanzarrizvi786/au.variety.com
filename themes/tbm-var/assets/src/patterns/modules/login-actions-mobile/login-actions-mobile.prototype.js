...
cxense_header_subscribe_widget.cxense_id_attr = 'cx-module-header-link-mobile-vy';

o_drop_menu.o_drop_menu_classes += ' lrv-u-whitespace-nowrap lrv-u-border-color-grey lrv-u-font-family-secondary';
o_drop_menu.o_drop_menu_list_classes += ' lrv-a-glue lrv-a-glue--r-0 lrv-u-width-300 lrv-u-background-color-white lrv-u-border-a-1 lrv-u-padding-a-1 u-background-color-accent-c-40';

o_drop_menu.c_span.c_span_text = 'Log in';
o_drop_menu.c_span.c_span_classes = 'lrv-u-color-white lrv-u-font-family-secondary lrv-u-font-size-10 u-color-brand-accent-20:hover u-padding-r-025';

o_drop_menu.c_span_logged_in.c_span_text = 'Account';
o_drop_menu.c_span_logged_in.c_span_classes = 'lrv-u-font-size-10 lrv-u-color-white u-letter-spacing-001 lrv-u-margin-l-050 u-color-brand-primary-40:hover';
o_drop_menu.o_drop_menu_toggle_classes_logged_in = 'a-hidden@mobile-max';
