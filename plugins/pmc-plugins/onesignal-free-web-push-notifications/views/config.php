    ...
    <div class="ui special padded raised stack segment">
      <form class="ui form" role="configuration" action="#" method="POST">
        ...
        <div class="ui borderless shadowless segment">
          ...
          <div class="field">
            <div class="ui toggle checkbox">
              <input type="checkbox" name="pmc_custom_sdk_init" value="true" <?php if ($onesignal_wp_settings['pmc_custom_sdk_init']) {
                      echo 'checked';
                  } ?>>
              <label>
                PMC - Enable Custom initialization
                <i class="tiny circular help icon link" role="popup" data-title="Enable PMC's Custom Initialization" data-content="Check this if you'd like to disable OneSignal's normal initialization and enable custom PMC initialization. Requires 'Disable OneSignal initialization' to be enabled, 'Automatically prompt new site visitors with OneSignal Slide Prompt before Native Browser Prompt' and 'Attempt to automatically prompt new site visitors with Native Browser Prompt' to be disabled."></i>
              </label>
            </div>
          </div>
          <div class="field">
            <div class="ui toggle checkbox">
              ...
              <label>
                  ...
                  <i class="tiny circular help icon link" role="popup" data-title="Show Notification Send Status Message" data-content="If enabled, a notice at the top of your admin interface will show 'Successfully sent a notification to # recipients.' after our plugin sends a notification."></i>
              </label>
            </div>
          </div>
        </div>
