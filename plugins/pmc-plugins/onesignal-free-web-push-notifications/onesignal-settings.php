...
class OneSignal {
  public static function get_onesignal_settings() {
    ...
    $defaults = array(
                  ...
                  'notifyButton_showcredit' => false,
                  'notifyButton_showAfterSubscribed' => false,
                  ...
                  'show_notification_send_status_message' => false,
    ...
    $legacies = array(
        ...
        'send_welcome_notification.default' => false,
