...
<script type="application/javascript">
	...
	(function ( blogherads ) {
		blogherads.adq.push( function () {
			...
			<?php if ( ! empty( $country_code_ad_unit_map ) ) { ?>
			blogherads.setConf( 'country_code_ad_unit_map', <?php echo wp_json_encode( $country_code_ad_unit_map ); ?> );
			<?php } ?>

			<?php if ( ! empty( $overwrite_dfp_name ) ) { ?>
			blogherads.setConf( 'dfp_name', <?php echo wp_json_encode( $overwrite_dfp_name ); ?> );
			<?php } ?>
