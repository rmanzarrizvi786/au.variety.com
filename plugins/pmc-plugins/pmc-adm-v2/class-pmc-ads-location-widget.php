...
class PMC_Ads_Location_Widget extends WP_Widget {
	...
	public function widget( $args = array(), $instance = array() ) {
		...
		if ( empty( $instance['wrap_div_class'] ) ) {
			pmc_adm_render_ads( $instance['ad_location'], '', true, $provider );
		} else {
			?>

			<div class="<?php echo esc_attr( $instance['wrap_div_class'] ); ?>">
				<?php pmc_adm_render_ads( $instance['ad_location'], '', true, $provider ); ?>
				<?php if ( false !== strpos( $instance['wrap_div_class'], 'clear' ) ) { ?>
					<div class="clear"></div>
				<?php } ?>
			</div>
