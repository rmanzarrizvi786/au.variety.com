...
define( 'DEFAULT_AD_PROVIDER', 'boomerang' );
define( 'PMC_ADM_URL', trailingslashit( plugins_url( '', __FILE__ ) ) );
define( 'PMC_ADM_VERSION', '2021.9' );
...
require_once( PMC_ADM_DIR . '/classes/class-rest-api.php' );
require_once( PMC_ADM_DIR . '/classes/class-ads-suppression.php' );
require_once( PMC_ADM_DIR . '/classes/class-ads-suppression-admin.php' );
...
PMC\Adm\REST_API::get_instance();
PMC\Adm\Ads_Suppression::get_instance();
PMC\Adm\Ads_Suppression_Admin::get_instance();
