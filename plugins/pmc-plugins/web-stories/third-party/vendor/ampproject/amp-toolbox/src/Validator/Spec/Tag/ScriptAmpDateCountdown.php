...
final class ScriptAmpDateCountdown extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-date-countdown', SpecRule::VERSION => ['0.1', '1.0', 'latest'], SpecRule::BENTO_SUPPORTED_VERSION => ['1.0']];
    /**
     ...
     * @var array
     */
    const VERSIONS_META = ['0.1' => ['hasCss' => \false, 'hasBento' => \false], '1.0' => ['hasCss' => \true, 'hasBento' => \true]];
    /**
     * Array of spec rules.
     *
     * @var array
