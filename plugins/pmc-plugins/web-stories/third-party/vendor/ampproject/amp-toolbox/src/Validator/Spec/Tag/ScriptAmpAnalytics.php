...
final class ScriptAmpAnalytics extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-analytics', SpecRule::VERSION => ['0.1', 'latest'], SpecRule::DEPRECATED_ALLOW_DUPLICATES => \true, SpecRule::REQUIRES_USAGE => 'EXEMPTED'];
    /**
