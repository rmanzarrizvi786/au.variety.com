...
final class DoctypeNode implements BeforeLoadFilter, AfterSaveFilter
{
    ...
    {
        return \preg_replace(self::HTML_SECURE_DOCTYPE_IF_NOT_FIRST_PATTERN, self::HTML_SECURE_DOCTYPE_REPLACEMENT_TEMPLATE, $html, 1, $this->securedDoctype);
    }
    /**
    ...
    public function afterSave($html)
    {
        ...
        return \preg_replace(self::HTML_RESTORE_DOCTYPE_PATTERN, self::HTML_RESTORE_DOCTYPE_REPLACEMENT_TEMPLATE, $html, 1);
    }
}
