...
final class ScriptCustomElementAmpFitTextAmp4email extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-fit-text', SpecRule::VERSION => ['0.1'], SpecRule::DEPRECATED_ALLOW_DUPLICATES => \true, SpecRule::REQUIRES_USAGE => 'EXEMPTED', SpecRule::VERSION_NAME => 'v0.1'];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::SPEC_NAME => 'SCRIPT[custom-element=amp-fit-text] (AMP4EMAIL)', SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP4EMAIL], SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC];
}
