...
final class ScriptAmpSubscriptionsGoogle extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-subscriptions-google', SpecRule::VERSION => ['0.1', 'latest'], SpecRule::REQUIRES_USAGE => 'NONE'];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP], SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC, SpecRule::REQUIRES_EXTENSION => [Extension::SUBSCRIPTIONS]];
}
