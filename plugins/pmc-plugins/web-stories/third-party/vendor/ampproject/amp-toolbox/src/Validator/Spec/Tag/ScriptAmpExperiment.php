...
final class ScriptAmpExperiment extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-experiment', SpecRule::VERSION => ['0.1', '1.0', 'latest'], SpecRule::DEPRECATED_ALLOW_DUPLICATES => \true, SpecRule::REQUIRES_USAGE => 'EXEMPTED'];
    /**
     ...
     * @var array
     */
    const VERSIONS_META = ['0.1' => ['hasCss' => \false, 'hasBento' => \false], '1.0' => ['hasCss' => \false, 'hasBento' => \false]];
    /**
     * Array of spec rules.
     *
     * @var array
