...
final class ScriptCustomElementAmpBindAmp4email extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-bind', SpecRule::VERSION => ['0.1'], SpecRule::REQUIRES_USAGE => 'NONE'];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::SPEC_NAME => 'SCRIPT[custom-element=amp-bind] (AMP4EMAIL)', SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP4EMAIL], SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC];
}
