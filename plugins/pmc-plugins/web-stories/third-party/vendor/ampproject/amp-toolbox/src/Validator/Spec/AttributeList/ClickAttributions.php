...
final class ClickAttributions extends AttributeList implements Identifiable
{
     ...
     * @var array<array>
     */
    const ATTRIBUTES = [Attribute::ATTRIBUTIONDESTINATION => [], Attribute::ATTRIBUTIONEXPIRY => [], Attribute::ATTRIBUTIONREPORTTO => [], Attribute::ATTRIBUTIONSOURCEEVENTID => [], Attribute::ATTRIBUTIONSOURCEID => [], Attribute::CONVERSIONDESTINATION => [], Attribute::IMPRESSIONDATA => [], Attribute::IMPRESSIONEXPIRY => [], Attribute::REPORTINGORIGIN => []];
}
