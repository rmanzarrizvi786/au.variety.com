...
final class InteractiveOptionsImgAttrs extends AttributeList implements Identifiable
{
     ...
     * @var array<array>
     */
    const ATTRIBUTES = [Attribute::OPTION_1_IMAGE => [SpecRule::MANDATORY => \true, SpecRule::VALUE_URL => [SpecRule::PROTOCOL => [Protocol::HTTP, Protocol::HTTPS]]], Attribute::OPTION_2_IMAGE => [SpecRule::MANDATORY => \true, SpecRule::VALUE_URL => [SpecRule::PROTOCOL => [Protocol::HTTP, Protocol::HTTPS]]], Attribute::OPTION_3_IMAGE => [SpecRule::VALUE_URL => [SpecRule::PROTOCOL => [Protocol::HTTP, Protocol::HTTPS]], SpecRule::TRIGGER => [SpecRule::ALSO_REQUIRES_ATTR => [Attribute::OPTION_3_IMAGE_ALT]]], Attribute::OPTION_4_IMAGE => [SpecRule::VALUE_URL => [SpecRule::PROTOCOL => [Protocol::HTTP, Protocol::HTTPS]], SpecRule::TRIGGER => [SpecRule::ALSO_REQUIRES_ATTR => [Attribute::OPTION_3_IMAGE, Attribute::OPTION_4_IMAGE_ALT]]], Attribute::OPTION_1_IMAGE_ALT => [SpecRule::MANDATORY => \true], Attribute::OPTION_2_IMAGE_ALT => [SpecRule::MANDATORY => \true], Attribute::OPTION_3_IMAGE_ALT => [SpecRule::TRIGGER => [SpecRule::ALSO_REQUIRES_ATTR => [Attribute::OPTION_3_IMAGE]]], Attribute::OPTION_4_IMAGE_ALT => [SpecRule::TRIGGER => [SpecRule::ALSO_REQUIRES_ATTR => [Attribute::OPTION_4_IMAGE]]]];
}
