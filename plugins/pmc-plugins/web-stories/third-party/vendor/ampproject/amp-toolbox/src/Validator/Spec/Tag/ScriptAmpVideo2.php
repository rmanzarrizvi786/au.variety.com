...
final class ScriptAmpVideo2 extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-video', SpecRule::VERSION => ['0.1', 'latest'], SpecRule::REQUIRES_USAGE => 'NONE', SpecRule::VERSION_NAME => 'v0.1'];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP, Format::AMP4ADS], SpecRule::SATISFIES => ['amp-video 0.1'], SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC, SpecRule::EXCLUDES => ['amp-video 1.0']];
}
