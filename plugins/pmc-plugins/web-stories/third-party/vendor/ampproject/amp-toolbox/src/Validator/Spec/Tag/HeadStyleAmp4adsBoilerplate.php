...
final class HeadStyleAmp4adsBoilerplate extends Tag implements Identifiable
{
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::STYLE, SpecRule::SPEC_NAME => 'head > style[amp4ads-boilerplate]', SpecRule::UNIQUE => \true, SpecRule::MANDATORY_PARENT => Element::HEAD, SpecRule::ATTRS => [Attribute::AMP4ADS_BOILERPLATE => [SpecRule::MANDATORY => \true, SpecRule::VALUE => [''], SpecRule::DISPATCH_KEY => 'NAME_VALUE_PARENT_DISPATCH']], SpecRule::ATTR_LISTS => [AttributeList\NonceAttr::ID], SpecRule::SPEC_URL => 'https://amp.dev/documentation/guides-and-tutorials/learn/a4a_spec/?format=ads#boilerplate', SpecRule::CDATA => [SpecRule::CDATA_REGEX => '\\s*body\\s*{\\s*visibility:\\s*hidden;?\\s*}\\s*', SpecRule::DOC_CSS_BYTES => \false], SpecRule::HTML_FORMAT => [Format::AMP4ADS], SpecRule::SATISFIES => ['style[amp-boilerplate]'], SpecRule::DESCRIPTIVE_NAME => 'head > style[amp4ads-boilerplate]'];
}
