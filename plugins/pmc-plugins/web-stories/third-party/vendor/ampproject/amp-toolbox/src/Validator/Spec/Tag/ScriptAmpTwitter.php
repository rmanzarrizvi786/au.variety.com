...
final class ScriptAmpTwitter extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-twitter', SpecRule::VERSION => ['1.0'], SpecRule::VERSION_NAME => 'v1.0', SpecRule::BENTO_SUPPORTED_VERSION => ['1.0']];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP], SpecRule::SATISFIES => ['amp-twitter 1.0'], SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC, SpecRule::EXCLUDES => ['amp-twitter 0.1']];
}
