...
final class ScriptAmpRender extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-render', SpecRule::VERSION => ['1.0', 'latest'], SpecRule::BENTO_SUPPORTED_VERSION => ['1.0']];
    /**
     ...
     * @var array
     */
    const VERSIONS_META = ['1.0' => ['hasCss' => \false, 'hasBento' => \true]];
    /**
     * Array of spec rules.
     *
     * @var array
