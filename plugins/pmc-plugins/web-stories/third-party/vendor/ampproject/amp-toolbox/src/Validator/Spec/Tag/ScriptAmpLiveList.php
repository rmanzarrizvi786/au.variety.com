...
final class ScriptAmpLiveList extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-live-list', SpecRule::VERSION => ['0.1', 'latest'], SpecRule::REQUIRES_USAGE => 'EXEMPTED'];
    /**
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::MANDATORY_PARENT => Element::HEAD, SpecRule::ATTR_LISTS => [AttributeList\CommonExtensionAttrs::ID], SpecRule::HTML_FORMAT => [Format::AMP], SpecRule::UNIQUE_WARNING => \true, SpecRule::EXTENSION_SPEC => self::EXTENSION_SPEC];
}
