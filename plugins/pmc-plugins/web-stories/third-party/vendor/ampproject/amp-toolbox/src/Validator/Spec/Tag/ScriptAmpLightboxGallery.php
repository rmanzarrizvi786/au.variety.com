...
final class ScriptAmpLightboxGallery extends TagWithExtensionSpec implements Identifiable
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-lightbox-gallery', SpecRule::VERSION => ['0.1', '1.0', 'latest'], SpecRule::REQUIRES_USAGE => 'NONE', SpecRule::BENTO_SUPPORTED_VERSION => ['1.0']];
    /**
     ...
     * @var array
     */
    const VERSIONS_META = ['0.1' => ['hasCss' => \true, 'hasBento' => \false], '1.0' => ['hasCss' => \true, 'hasBento' => \true]];
    /**
     * Array of spec rules.
     *
     * @var array
