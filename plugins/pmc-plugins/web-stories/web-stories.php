...
define( 'WEBSTORIES_VERSION', '1.15.0' );
define( 'WEBSTORIES_DB_VERSION', '3.0.13' );
define( 'WEBSTORIES_AMP_VERSION', '2.2.0-alpha' ); // Version of the AMP library included in the plugin.
...
define( 'WEBSTORIES_CDN_URL', 'https://wp.stories.google/static/14' );
