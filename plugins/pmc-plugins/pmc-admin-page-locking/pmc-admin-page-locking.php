...
define( 'PMC_ADMIN_PAGE_LOCKING_URL', untrailingslashit( plugins_url( '', __FILE__ ) ) );
define( 'PMC_ADMIN_PAGE_LOCKING_DIR', __DIR__ );

require_once PMC_ADMIN_PAGE_LOCKING_DIR . '/classes/class-screen.php';

function pmc_get_admin_screens_for_locking() {
	/**
	 * Filter the screens that should be setup to be "locked".
	 *
	 * @param array $screens Array of screens (pagenames/hook suffixes)
	 * on which to enable locking.
	 */
	$screens = apply_filters( 'pmc_admin_page_locking_screens', [] );
...
add_action( 'after_setup_theme', 'PMC\Admin_Page_Locking\pmc_get_admin_screens_for_locking' );
