...
class PMC_Yahoo_Top_Deals {
	...
	public function create_pmc_carousel_term() : void {
		...
		if ( class_exists( 'PMC_Carousel' ) ) {
			...
			$term_exists_todays_deals = wpcom_vip_term_exists( self::TODAYS_YAHOO_TOP_DEALS_TERM_SLUG, \PMC_Carousel::modules_taxonomy_name );
			...
			$term_exists_more_deals = wpcom_vip_term_exists( self::MORE_YAHOO_TOP_DEALS_TERM_SLUG, \PMC_Carousel::modules_taxonomy_name );
