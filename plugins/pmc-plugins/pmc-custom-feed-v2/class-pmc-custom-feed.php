...
class PMC_Custom_Feed
{
	...
	public function metabox_manager()
	{
		...
		x_add_metadata_field(
			self::meta_custom_name . 'taxonomy',
			$post_array,
			array(
				'group'       => $grp_name,
				'label'       => 'Taxonomy',
		...
		x_add_metadata_field(
			self::meta_custom_name . 'template',
			$post_array,
			array(
				'group'          => $grp_name,
				'label'          => 'Feed Template',
		...
		x_add_metadata_field(
			self::meta_custom_name . 'image_size',
			$post_array,
			array(
				'group'             => $grp_name,
		...
		// add option for it
		x_add_metadata_field(
			self::meta_custom_name . 'query_string',
			$post_array,
			array(
				'group'       => $grp_name,
		...
		x_add_metadata_field(
			self::meta_custom_name . 'tracking',
			$post_array,
			array(
				'group'      => $grp_name,
		...
		x_add_metadata_field(
			self::meta_custom_name . 'post_type',
			$post_array,
			array(
				'group'             => $grp_name,
		...
		x_add_metadata_field(
			self::meta_custom_name . 'prepend_text_p1',
			$post_array,
			array(
				'group'      => $grp_name,
	...
	public function sanitize_image_size($field_slug, $field, $object_type, $object_id, $value)
	{
		...
		if (has_image_size($value)) {
			...
			if (
				empty($img_size[0])  || empty($img_size[1])
