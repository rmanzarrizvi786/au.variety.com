...
class Qmerce_Admin_Box
{
    ...
    public function addAuthCode()
    {
        ...
        echo '<script>window.authToken = "' . esc_js( $authToken ) . '";</script>';
    }
    ...
    public function renderMetaBoxContent($post)
    {
        ...
        echo '<iframe id="qmerce_meta_box_suggestions" src="' . esc_url( QMERCE_EDITOR_BASEURL . '/#/editor-suggestions/wordpress?access_token=' . $authToken ) . '" width="100%" height="135" scrolling="no"></iframe>';
    }
