  ...
  render() {
    ...
    return (
      <div className="c-list__picture_video_container">
        <div
          ref={this.launchVideoRef}
          className="c-list__picture_video u-gallery-react-placeholder-shimmer"
          data-pmc-gallery-video
        >
          <div
            hidden
          ...
          <div className="c-card__badge">
            <svg
              className="c-play-btn c-play-btn--clock c-play-btn--big-clock"
              viewBox="0 0 88 88"
            >
              <g
                transform="translate(-.082 -.082)"
                fill="none"
                fillRule="evenodd"
              >
                <circle
