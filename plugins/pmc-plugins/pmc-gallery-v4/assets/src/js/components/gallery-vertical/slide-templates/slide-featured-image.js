...
class SlideAlbum extends React.Component {
  ...
  toggleSocialIcons(event, state) {
    ...
    const displaySocialIcons =
      "undefined" === typeof state ? !this.state.displaySocialIcons : state;
  ...
  render() {
    ...
    const innerImageCredit = (
      <span className="c-gallery-vertical-slide__photo-credit">
        {imageCredit}
      </span>
    );
      ...
      <article className="c-gallery-vertical-featured-image">
        <div className="c-gallery-vertical-featured-image__header">
          {ordering && ordering !== "none" && (
            <span
              className="c-gallery-vertical-featured-image__number"
              style={this.props.listItemStyles.rankNumberStyle}
            >
              {this.props.positionDisplay}
            </span>
          )}
          <h2
            className="c-gallery-vertical-featured-image__title"
          ...
          >
            <div className="c-gallery-vertical-featured-image__share-icons">
              {this.state.displaySocialIcons && (
                <CSSTransitionGroup
                  transitionName="c-gallery-vertical-share__animation"
        ...
        {video && <ResponsiveVideoImage {...this.props} />}
        ...
        {imageCredit && (
          <div className="c-gallery-vertical-slide__photo-credit-wrapper">
            <Fragment>
              {caption && (
                <div
                  className="c-gallery-vertical-featured-image__caption"
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(caption),
                  }}
                />
              )}
              <span className="c-gallery-vertical-slide__photo-credit-text">
                {i10n.vertical.photo}
              </span>
              ...
              {imageSourceUrl ? (
                <a
                  ...
                  className="c-gallery-vertical-slide__image-source-url"
                >
                  {innerImageCredit}
                </a>
              ) : (
        ...
        <div
          className="c-gallery-vertical-featured-image__description"
          dangerouslySetInnerHTML={{
