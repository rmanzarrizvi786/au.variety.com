( function ( $ ) {
	...
	$( document ).ready( function () {
		...
		$( 'select#bulk-action-selector-top option:last-child' ).before( $( '<option/>', {
			value: 'bulk_attachment_tag',
			text: 'Add Attachment Tags',
		} ) );

		$( 'select#bulk-action-selector-bottom option:last-child' ).before( $( '<option/>', {
			value: 'bulk_attachment_tag',
			text: 'Add Attachment Tags',
		} ) );
		...
		$( 'select#bulk-action-selector-top' ).on( 'change', function () {
			...
			id: 'bulk-attachment-tag-top',
			type: 'search',
			placeholder: 'Comma-delimited list of Tags',
			name: 'bulk-attachment-tag-top',
			class: 'bulk-attachment-tag',
			style: 'display: none;'
		} ) );
		...
		$( 'select#bulk-action-selector-bottom' ).on( 'change', function () {
			...
			id: 'bulk-attachment-tag-bottom',
			type: 'search',
			placeholder: 'Comma-delimited list of Tags',
			name: 'bulk-attachment-tag-bottom',
			class: 'bulk-attachment-tag',
			style: 'display: none;'
		} )  );
	} );
